...
public class StringMethod3 {
    public static void main(String[] args) {
        ...
        // startWith() : 해당 문자열로 시작하는 지 여부 확인
        boolean res7 = str.startsWith("시계");    // true
        boolean res8 = str.startsWith("고장");    // false
        // 2번째 인자로 받는 인덱스 위치부터 확인
        boolean res10 = str.startsWith("시계", 3);    // false
        boolean res11 = str.startsWith("고장", 4);    // true (0번지부터 시작)

        // endWith : 해당 문자열로 끝나는지 여부 확인
        boolean res12 = str.endsWith("똑똑");     // true
        boolean res13 = str.endsWith("시계");     // false

        // startWith()와 endWith()는 모두 공백도 포함함.
