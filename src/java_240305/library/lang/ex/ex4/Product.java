package java_240305.library.lang.ex.ex4;
...
// 생성자
    ...
    public String toString() {
        return "상품: %s, 가격: %f, 수량: %d".formatted(name, price, quantity);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("toString 메서드 호출 결과 (product2): " + product1.toString());
