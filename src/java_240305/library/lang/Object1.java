...
public class Object1 {
    ...
    public static void main(String[] args) throws Exception{
        Object object = new Object1();

        String string = object.toString();
        boolean b1 = object.equals(object);
        int hashCode = object.hashCode();

        // 객체가 속한 클래스의 메타(데이터에 대한) 정보를 반환하는 메서드
        ...
        object.wait();          // 현재 스레드 일시 중단하고 깨울때까지 기다림.
        object.wait(1000);  // 스레드 중단하고 n밀리초 기다림
        object.wait(100, 100);  // 스레드를 중단하고 n밀리초, m나노초 기다림

//        object.clone();
// 객체의 복제본을 생성하는 메서드
//        object.finalize();
// 더 이상 사용하지 않는 메서드  -> Garbage Collector 에 의해 객체가 삭제되기 전 호출되는 메서드
