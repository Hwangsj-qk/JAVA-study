...
public class Ex2 {
    ...
    사용자로부터 여러 도시 이름을 입력받아, 입력된 도시 이름 중 고유한 도시 이름만을 저장하고 출력하는 간단한
    콘솔 프로그램을 작성합니다
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.print("도시 이름을 입력하세요 (종료: '종료' 입력) : ");
            String city = scanner.nextLine();
            String lowerCaseCity = city.toLowerCase();
            String replace = lowerCaseCity.replace(lowerCaseCity.charAt(0),
                    lowerCaseCity.toUpperCase().charAt(0));

            // 앞글자 대문자 이 방법도 있음
            //replace = city.substring(0,1).toUpperCase() + city.substring(1).toLowerCase();
