...
public class Ex1 {
    ...
    출력하는 자바 프로그램을 작성하세요. 입력된 URL에 대해 다음 정보를 출력해야 합니다:
    ...
    public static void main(String[] args) {
        URL url = null;
        try {
            url = new URL("https://www.example.com:8080/path/to/resource?name=John&age=30#section");
        ...
        if (ref == null) {
            System.out.println("참조: 참조없음");
        } else
            System.out.println("참조: " + ref);
