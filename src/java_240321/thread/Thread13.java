    ...
    public static void main(String[] args) {
        ...
        Thread thread1 = new Thread(() -> {
            synchronized (lock) {
                ...
                System.out.println("스레드 1 : 알림 받았습니다 ");         // (4)
            }
        });
        ...
        Thread thread2 = new Thread(() -> {
            ...
            synchronized (lock) {
                ...
                lock.notify();
                // notify 호출 후에도 동기화 블록 종료할 때까지 계속 사용
                System.out.println("스레드 2 : 알리고 동기화 블록 종료 중입니다. ");      // (3)
            }
        });
        // thread 2가 완전히 끝나야 thread 1로 넘어감
