...
public class Ex5 {
     ...
     */
    public static void main(String[] args) throws InvaildEmailException {
        Scanner scanner = new Scanner(System.in);
        System.out.print("비밀번호를 입력하세요: ");
        String password = scanner.nextLine();

        try {
            vaildatePassword(password); // 예외 코드 발생 => catch 문으로 이동
            // 예외가 발생하지 않았을 경우
    ...
    private static void vaildatePassword(String password) {
