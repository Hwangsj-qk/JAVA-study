...
import java_240318.lambda.ex.ex5.Person;
...
public class Ex5 {
    ...
    // 18세 이상 여부 확인
    Predicate<Person> function = (person1) -> {
        ...
        for (Person attendee : attendees) {
            // 참석자 명단에서 18세 이상인 경우만 필터링해서 새로운 초대명단에
            // 이름을 추가할 것
            if(function.test(attendee)) {
