...
public class Ex2 {
    ...
    public static void main(String[] args) {
        ...
        Function<String, String> dateSentence = rawSentence
                -> (rawSentence.substring(0, 4) + "-" + rawSentence.substring(4, 6) + "-" + rawSentence.substring(6, 8));
        String completedSentence = dateSentence.apply("20240320");
