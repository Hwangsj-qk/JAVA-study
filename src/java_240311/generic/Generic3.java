...
public class Generic3 {
    ...
    public static void main(String[] args) {
        ...
        String content2 = box.contet2;      // T
        Double antherTypeContent = box. anotherTypeCount;       // S
        Character anotherTypeContent2 = box. anotherTypeContent2;   // S
