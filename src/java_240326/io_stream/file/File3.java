package java_240326.io_stream.file;
...
public class File3 {
    ...
    public static void main(String[] args) {
        ...
        Path path1 = Paths.get("src", "java_240326","io_stream", "file");
        Path absolutePath1 = path1.toAbsolutePath();

        System.out.println("path1 = " + path1);
        // path1 = src\io_stream\file
        System.out.println("absolutePath1 = " + absolutePath1);
        // absolutePath1 = C:\Users\admin\IdeaProjects\JAVAstudy\src\io_stream\file
...
//            System.out.println("파일을 성공적으로 복사했습니다.");
        ...
        // Files를 이용한 파일 쓰기
        try {
            Files.write(targetPath, "안녕하세요".getBytes());     // 문자열을 바이트로 바꿈
        } catch (IOException e) {
            throw new RuntimeException(e);
        }

        // 여러 줄 쓰기
        List<String> stringList = Arrays.asList("안녕하세요", "반갑습니다", "여러 줄 텍스트입니다.",
                "문자열이 나누어져 들어가 있습니다.");
        // 각각의 요소가 한줄씩 출력 (copyFile에 출력)
