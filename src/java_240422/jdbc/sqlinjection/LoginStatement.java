...
public class LoginStatement {
    ...
    public static void main(String[] args) {
        ...
        // 비정상적인 SQL 인젝션 : abcd OR 'x' = 'x => OR 조건 SQL문으로 인식하고 로그인 성공하는 것을 방지
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            // Prepare 가 아닌 Statement로 매개변수가 있는 쿼리문을 작성할 경우
            ...
            // SQL 인젝션 공격
            // SELECT * FROM users WHERE userId = 'anyting' AND password = 'abcd' or 'x'='x'

            // Statement 에서 매개변수로 받아 작성할 경우 SQL 인젝션 공격의 위험이 높다.
